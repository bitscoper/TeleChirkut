  ...
  if ($type == "Edit_Profile") {
    if (isset($_POST["timezone"])) {
      ...
      require_once $includings_path .
        "Manually_Required/Introduction_Editor.php";
    ...
    require_once $includings_path .
      "Manually_Required/Log_In_Sessions_Retreiver.php";
    ...
    if (Check_User($to_profile_code)) {
      require_once $includings_path .
        "Manually_Required/Text_Message_Receiver.php";
    ...
    require_once $includings_path .
      "Manually_Required/Unseen_Counts_Retriever.php";
    ...
    require_once $includings_path .
      "Manually_Required/Messages_Connections_Retriever.php";
    ...
    if (Check_User($to_profile_code)) {
      require_once $includings_path .
        "Manually_Required/Image_Message_Receiver.php";
    ...
    if (Check_User($profile_code)) {
      require_once $includings_path .
        "Manually_Required/Profile_Elements_Generator.php";
    ...
    if (Check_Post($serial)) {
      require_once $includings_path .
        "Manually_Required/Post_Details_Retriever.php";
    ...
    require_once $includings_path .
      "Manually_Required/Notifications_Retriever.php";

    header("Content-Type: application/json");
    return Retrieve_Notifications();
  } elseif ($type == "List_FeedLine_Posts") {
    require_once $includings_path .
      "Manually_Required/FeedLine_Posts_Lister.php";

    header("Content-Type: application/json");
    return List_FeedLine_Posts();
  } elseif ($type == "List_Reacted_Posts") {
    require_once $includings_path .
      "Manually_Required/Reacted_Posts_Lister.php";
    ...
    require_once $includings_path .
      "Manually_Required/Another_Session_Ender.php";
    ...
    if (Check_User($profile_code)) {
      require_once $includings_path .
        "Manually_Required/Profile_Card_Retriever.php";
