...
function Bundle_JavaScript($is_development_mode)
{
  ...
  $javascript .= file_get_contents(
    $third_party_includings .
      "3rd_Party_JavaScript_Includings/Croppie/Croppie.js",
  );

  foreach (glob("../JavaScript_Includings/*.js") as $javascript_including) {
    $javascript .= file_get_contents(
      "../JavaScript_Includings/" . $javascript_including,
    );
  }
  ...
  if (!$is_development_mode) {
    require_once $third_party_includings .
      "3rd_Party_PHP_Includings/JShrink/Minifier.php";
    require_once $third_party_includings .
      "3rd_Party_PHP_Includings/HunterObfuscator/HunterObfuscator.php";
